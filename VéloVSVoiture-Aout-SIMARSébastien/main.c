...
void handleResize(int width,int heigth)//gère la taille de la carte, mais ne fonctionne pas
{
...
void Display()// fait appel à game! (boucle qui redessine l'écran (refresh de l'ecran))
{
