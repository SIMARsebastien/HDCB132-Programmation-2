...
void textmenu() //fonction qui gere l'affichage du menu principal
{ 
		glMatrixMode(GL_MODELVIEW);
		glLoadIdentity();
		...
		vBitmapOutput(300,150,"NEW GAME (press N)",GLUT_BITMAP_HELVETICA_18);

		glColor3d(1,0.65,0); // orange vif
		vBitmapOutput(300,200,"LOAD GAME (L)",GLUT_BITMAP_HELVETICA_18);

		glColor3d(1,1,0); // jaune
		vBitmapOutput(300,350,"SCORES (S)",GLUT_BITMAP_HELVETICA_18);
...
void drawtextacceuil()//dessine la première page
{
	...
	vBitmapOutput(300,400,"Meilleur score: 1315",GLUT_BITMAP_HELVETICA_18);
	glColor3d(1,1,1); // Texte en blanc
...
void drawScores()
{
		...
		vBitmapOutput(300,100,"1: ",GLUT_BITMAP_HELVETICA_18);
		vBitmapOutput(300,135,"2: ",GLUT_BITMAP_HELVETICA_18);
		vBitmapOutput(300,170,"3: ",GLUT_BITMAP_HELVETICA_18);
		vBitmapOutput(300,205,"4: ",GLUT_BITMAP_HELVETICA_18);
		vBitmapOutput(300,240,"5: ",GLUT_BITMAP_HELVETICA_18);
		vBitmapOutput(300,275,"6: ",GLUT_BITMAP_HELVETICA_18);
		vBitmapOutput(300,310,"7: ",GLUT_BITMAP_HELVETICA_18);
		vBitmapOutput(300,345,"8: ",GLUT_BITMAP_HELVETICA_18);
		vBitmapOutput(300,380,"9: ",GLUT_BITMAP_HELVETICA_18);
		vBitmapOutput(300,415,"10: ",GLUT_BITMAP_HELVETICA_18);
}